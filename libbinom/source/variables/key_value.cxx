...
KeyValue::KeyValue(const literals::bitarr bit_array)
  : type(VarKeyType::bit_array), data{.bit_array_header = priv::BitArrayHeader::create(bit_array)} {}
KeyValue::KeyValue(const BitArray& value) noexcept
  : type(VarKeyType::bit_array), data{.bit_array_header = priv::BitArrayHeader::copy(value.getData())} {}
KeyValue::KeyValue(BitArray&& value) noexcept
  : type(VarKeyType::bit_array), data{.bit_array_header = priv::BitArrayHeader::copy(value.getData())} {}

KeyValue::KeyValue(const literals::ui8arr ui8_array)
  : type(VarKeyType::ui8_array), data{.buffer_array_header = priv::BufferArrayHeader::create(ui8_array)} {}
KeyValue::KeyValue(const literals::i8arr i8_array)
  : type(VarKeyType::si8_array), data{.buffer_array_header = priv::BufferArrayHeader::create(i8_array)} {}
KeyValue::KeyValue(const literals::ui16arr ui16_array)
  : type(VarKeyType::ui16_array), data{.buffer_array_header = priv::BufferArrayHeader::create(ui16_array)} {}
KeyValue::KeyValue(const literals::i16arr i16_array)
  : type(VarKeyType::si16_array), data{.buffer_array_header = priv::BufferArrayHeader::create(i16_array)} {}
KeyValue::KeyValue(const literals::ui32arr ui32_array)
  : type(VarKeyType::ui32_array), data{.buffer_array_header = priv::BufferArrayHeader::create(ui32_array)} {}
KeyValue::KeyValue(const literals::i32arr i32_array)
  : type(VarKeyType::si32_array), data{.buffer_array_header = priv::BufferArrayHeader::create(i32_array)} {}
KeyValue::KeyValue(const literals::f32arr f32_array)
  : type(VarKeyType::f32_array), data{.buffer_array_header = priv::BufferArrayHeader::create(f32_array)} {}
KeyValue::KeyValue(const literals::ui64arr ui64_array)
  : type(VarKeyType::ui64_array), data{.buffer_array_header = priv::BufferArrayHeader::create(ui64_array)} {}
KeyValue::KeyValue(const literals::i64arr i64_array)
  : type(VarKeyType::si64_array), data{.buffer_array_header = priv::BufferArrayHeader::create(i64_array)} {}
KeyValue::KeyValue(const literals::f64arr f64_array)
  : type(VarKeyType::f64_array), data{.buffer_array_header = priv::BufferArrayHeader::create(f64_array)} {}
KeyValue::KeyValue(const BufferArray& value) noexcept
  : type(toKeyType(value.getValType())), data{.buffer_array_header = priv::BufferArrayHeader::copy(value.getData())} {}
...
KeyValue::KeyValue(const KeyValue& value) noexcept : type(value.type) {
  ...
  case binom::VarTypeClass::bit_array:
    data.bit_array_header = priv::BitArrayHeader::copy(value.data.bit_array_header);
  return;
  case binom::VarTypeClass::buffer_array:
    data.buffer_array_header = priv::BufferArrayHeader::copy(value.data.buffer_array_header);
  return;
...
size_t KeyValue::getElementCount() const noexcept {
  ...
  case binom::VarTypeClass::bit_array: return data.bit_array_header->getBitSize();
  case binom::VarTypeClass::buffer_array: return data.buffer_array_header->getSize();
  }
}
